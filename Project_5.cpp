...
const char *WINDOWTITLE = { "Project_5 -- Yi-Jung Chiang" };
...
Display( )
{
    ...
    gluLookAt( 0.2, 0.2, 3,     0., 0.5, 0.,     0., 1., 0. );
    ...
    ColorR = 0.5;
    ColorG = 0.7 * sin(90*Time);
    ColorB = 0.3 * sin(90*Time);

    Ka = 0.6;
    Kd = 0.9;
    Ks = 0.5;

    SpecularColorR = 0.2 * sin(90*Time);
    SpecularColorG = 0.2 * sin(90*Time);
    SpecularColorB = 0.2 * sin(90*Time);
