...
GLuint  HelicopterList;         // HeliList display List
GLuint  BladeList ;             // BladeList display List
float  Time = 0;
bool    Frozen;
...
Display( )
{
    ...
    if (WhichPerspective == INSIDE) {
        ...
        gluLookAt(11., 8., 10., 0., 0., 1.6, 0., 1., 0.);
    ...
    glCallList(BladeList);
    glPopMatrix();
    // draw the circle in front of helicopter
    glPushMatrix();
    glTranslatef(0., 0., -10.);
    glColor3f(1., 1., 0.);
