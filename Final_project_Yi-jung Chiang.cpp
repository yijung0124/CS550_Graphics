...
const char *WINDOWTITLE = { "Final Project -- Yi-Jung Chiang" };
...
Display( )
{
    ...
    if(Lightp1 == 0)
        ...
        glMaterialfv(GL_FRONT, GL_DIFFUSE, Array3(0, 0, 0));
        glMaterialfv(GL_FRONT, GL_SPECULAR, MulArray3(.8f, Black));
    }
    ...
    glLoadIdentity( );
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., "Final project-solar system");
...
InitGraphics( )
{
    ...
    //Star Texture
    Texture = BmpToTexture("starmap.bmp", &Width, &Height);
...
Reset( )
{
    ...
    WhichProjection = PERSP;
    Xrot = Yrot = 0.;
    Lightp1 = Lightp2 = Lightp3 = Lightp4 = Lightp5 = Lightp6 = Lightp7 = Lightp8 = Lightp9 = 1;
}
