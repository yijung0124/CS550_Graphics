...
const char *WINDOWTITLE = { "Project_6 - Yi-Jung Chiang" };
...
Display( )
{
    ...
    //ears
    RotateZ(&Curves[5].p1, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    RotateZ(&Curves[5].p2, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    Curves[5].r = rgb[0]; Curves[5].g = rgb[1]; Curves[5].b = rgb[2];

    RotateZ(&Curves[6].p1, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    RotateZ(&Curves[6].p2, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    Curves[6].r = rgb[0]; Curves[6].g = rgb[1]; Curves[6].b = rgb[2];

    //mouth line
    RotateX(&Curves[7].p1, 5 * sin(120 * M_PI * Time), 3, 0, 0);
    RotateX(&Curves[7].p2, -15 * sin(120 * M_PI * Time), 6, -6, 0);
    Curves[7].r = rgb[0]; Curves[7].g = rgb[1]; Curves[7].b = rgb[2];

    RotateY(&Curves[8].p1, 5 * sin(120 * M_PI * Time), -3, 0, 0);
    RotateY(&Curves[8].p2, -15 * sin(120 * M_PI * Time), -6, -6, 0);
    Curves[8].r = rgb[0]; Curves[8].g = rgb[1]; Curves[8].b = rgb[2];

    //body
    RotateX(&Curves[13].p1, 5 * sin(120 * M_PI * Time), -3, 0, -3);
    RotateX(&Curves[13].p2, -15 * sin(120 * M_PI * Time), 6, 0, 3);
    Curves[13].r = rgb[0]; Curves[13].g = rgb[1]; Curves[13].b = rgb[2];


    Curves[1].r = 1; Curves[1].g = 1; Curves[1].b = 0;
    Curves[2].r = 1; Curves[2].g = 1; Curves[2].b = 0;
    Curves[3].r = 1; Curves[3].g = 1; Curves[3].b = 0;
    Curves[4].r = 1; Curves[4].g = 1; Curves[4].b = 0;
    Curves[9].r = 1; Curves[9].g = 0; Curves[9].b = 0;
    Curves[10].r = 1; Curves[10].g = 0; Curves[10].b = 0;
    Curves[11].r = 1; Curves[11].g = 1; Curves[11].b = 1;
    Curves[12].r = 1; Curves[12].g = 1; Curves[12].b = 1;
...
//    glColor3f( 0., 1., 1. );
    ...
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., "Project_6 Yi-Jung Chiang" );
...
InitGraphics( )
{
    ...
    Curves[1].p0.x0 = 1.5 * cos(0 * M_PI/180); Curves[1].p0.y0 = 1.5 * sin(0 * M_PI/180); Curves[1].p0.z0 = 0;
    Curves[1].p0.x = Curves[1].p0.x0; Curves[1].p0.y = Curves[1].p0.y0; Curves[1].p0.z = Curves[1].p0.z0;
    Curves[1].p1.x0 = 1.8* cos(30 * M_PI/180); Curves[1].p1.y0 = 1.8 * sin(30 * M_PI/180); Curves[1].p1.z0 = 0.0;
    Curves[1].p1.x = Curves[1].p1.x0; Curves[1].p1.y = Curves[1].p1.y0; Curves[1].p1.z = Curves[1].p1.z0;
    Curves[1].p2.x0 = 1.8 * cos(60 * M_PI/180); Curves[1].p2.y0 = 1.8 * sin(60 * M_PI/180); Curves[1].p2.z0 = 0.0;
    ...
    Curves[2].p1.x0 = 1.8 * cos(120 * M_PI/180); Curves[2].p1.y0 = 1.8 * sin(120 * M_PI/180); Curves[2].p1.z0 = 0.0;
    Curves[2].p1.x = Curves[2].p1.x0; Curves[2].p1.y = Curves[2].p1.y0; Curves[2].p1.z = Curves[2].p1.z0;
    Curves[2].p2.x0 = 1.8 * cos(150 * M_PI/180); Curves[2].p2.y0 = 1.8 * sin(150 * M_PI/180); Curves[2].p2.z0 = 0.0;
    Curves[2].p2.x = Curves[2].p2.x0; Curves[2].p2.y = Curves[2].p2.y0; Curves[2].p2.z = Curves[2].p2.z0;
    Curves[2].p3.x0 = 1.5 * cos(180 * M_PI/180); Curves[2].p3.y0 = 1.5 * sin(180 * M_PI/180); Curves[2].p3.z0 = 0;
    ...
    Curves[3].p0.x0 = 1.5 * cos(180 * M_PI/180); Curves[3].p0.y0 = 1.5 * sin(180 * M_PI/180); Curves[3].p0.z0 = 0;
    Curves[3].p0.x = Curves[3].p0.x0; Curves[3].p0.y = Curves[3].p0.y0; Curves[3].p0.z = Curves[3].p0.z0;
    Curves[3].p1.x0 = 1.8 * cos(210 * M_PI/180); Curves[3].p1.y0 = 1.8 * sin(210 * M_PI/180); Curves[3].p1.z0 = 0.0;
    Curves[3].p1.x = Curves[3].p1.x0; Curves[3].p1.y = Curves[3].p1.y0; Curves[3].p1.z = Curves[3].p1.z0;
    Curves[3].p2.x0 = 1.8 * cos(240 * M_PI/180); Curves[3].p2.y0 = 1.8 * sin(240 * M_PI/180); Curves[3].p2.z0 = 0.0;
    ...
    Curves[4].p1.x0 = 1.8 * cos(300 * M_PI/180); Curves[4].p1.y0 = 1.8 * sin(300 * M_PI/180); Curves[4].p1.z0 = 0.0;
    Curves[4].p1.x = Curves[4].p1.x0; Curves[4].p1.y = Curves[4].p1.y0; Curves[4].p1.z = Curves[4].p1.z0;
    Curves[4].p2.x0 = 1.8 * cos(330 * M_PI/180); Curves[4].p2.y0 = 1.8 * sin(330 * M_PI/180); Curves[4].p2.z0 = 0.0;
    Curves[4].p2.x = Curves[4].p2.x0; Curves[4].p2.y = Curves[4].p2.y0; Curves[4].p2.z = Curves[4].p2.z0;
    Curves[4].p3.x0 = 1.5 * cos(360 * M_PI/180); Curves[4].p3.y0 = 1.5 * sin(360 * M_PI/180); Curves[4].p3.z0 = 0;
    ...
    Curves[5].p0.x0 = 1.8 * cos(120 * M_PI/180); Curves[5].p0.y0 = 1.8 * sin(120 * M_PI/180); Curves[5].p0.z0 = 0.0;
    Curves[5].p0.x = Curves[5].p0.x0; Curves[5].p0.y = Curves[5].p0.y0; Curves[5].p0.z = Curves[5].p0.z0;
    Curves[5].p1.x0 = 5 *cos(130 * M_PI/180); Curves[5].p1.y0 = 5 * sin(130 * M_PI/180); Curves[5].p1.z0 = 0.0;
    Curves[5].p1.x = Curves[5].p1.x0; Curves[5].p1.y = Curves[5].p1.y0; Curves[5].p1.z = Curves[5].p1.z0;
    Curves[5].p2.x0 = 5 *cos(135 * M_PI/180); Curves[5].p2.y0 = 5 *sin(135 * M_PI/180); Curves[5].p2.z0 = 0.0;
    Curves[5].p2.x = Curves[5].p2.x0; Curves[5].p2.y = Curves[5].p2.y0; Curves[5].p2.z = Curves[5].p2.z0;
    Curves[5].p3.x0 =  1.8 * cos(150 * M_PI/180); Curves[5].p3.y0 = 1.8 * sin(150 * M_PI/180); Curves[5].p3.z0 = 0.0;
    ...
    Curves[6].p0.x0 = 1.8* cos(30 * M_PI/180); Curves[6].p0.y0 = 1.8 * sin(30 * M_PI/180); Curves[6].p0.z0 = 0.0;
    Curves[6].p0.x = Curves[6].p0.x0; Curves[6].p0.y = Curves[6].p0.y0; Curves[6].p0.z = Curves[6].p0.z0;
    Curves[6].p1.x0 = 5 * cos( 40 * M_PI/180); Curves[6].p1.y0 = 5 * sin(40 * M_PI/180); Curves[6].p1.z0 = 0.0;
    Curves[6].p1.x = Curves[6].p1.x0; Curves[6].p1.y = Curves[6].p1.y0; Curves[6].p1.z = Curves[6].p1.z0;
    Curves[6].p2.x0 = 5 * cos(45 * M_PI/180); Curves[6].p2.y0 = 5 * sin(45 * M_PI/180); Curves[6].p2.z0 = 0.0;
    Curves[6].p2.x = Curves[6].p2.x0; Curves[6].p2.y = Curves[6].p2.y0; Curves[6].p2.z = Curves[6].p2.z0;
    Curves[6].p3.x0 = 1.8* cos(60 * M_PI/180); Curves[6].p3.y0 = 1.8 * sin(60 * M_PI/180); Curves[6].p3.z0 = 0.0;
